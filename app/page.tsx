  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="container mx-auto max-w-4xl px-4 py-8">
        ...
        {portfolioData.customSections && portfolioData.customSections.find(s => s.id === "3bd1f843-ef6d-40b6-b8e8-e3eaa4403c13") && (() => {
          const section = portfolioData.customSections.find(s => s.id === "3bd1f843-ef6d-40b6-b8e8-e3eaa4403c13")
